...
const emptyBootcamp = { slug:'', title:'', date:'', location:'', theme:'', status:'upcoming', overview:'', objectives:[], topics:[], speakers:['Wilcom Duncan'], images:[], videos:[], testimonials:[] };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <button onClick={()=>setEditing({...emptyBootcamp})} className={btnPrimary}><Plus className="w-4 h-4" />New Bootcamp</button>
      </div>
